...
public class SearchTestCountryFrance extends TestBase {
	...
	public SearchTestCountryFrance()
	{
		super();
	}
	...
	*/
	...
	public void setUp() throws Throwable {
	    ...
	    if (browserName.equals("Firefox")) {
			String userid = prop.getProperty("userid_CountryFrance");
			String password = prop.getProperty("password_CountryFrance");
			ProductBrowserUtil.Login(userid, password);
		} // Firefox
	    // Set the Language
	    Thread.sleep(5000);
	    String language = prop.getProperty("language_CountryFrance");
	...
	public Object[][] getSearchDetailsData() {
	   ...
	   Object data[][] =ExcelUtil.getTestData("SearchDetails_France");
	   return data;
	}
	

	@Test(dataProvider = "getSearchDetailsData")
	public void SearchDetails_France (String username, String password, String language, String searchText, String partNumber,
	...
	*/
	...
	public Object[][] getBOMData() {
	   ...
	   Object data[][] =ExcelUtil.getTestData("SearchBOM_France");
	...
	public void SearchBOM_France (String username, String password, String language, String searchText, String partNumber,
	...
	*/	
	...
	public Object[][] getContainsInData() {
	   ...
	   Object data[][] =ExcelUtil.getTestData("SearchContainsIn_France");
	   return data;
	}
	
	@Test(dataProvider = "getContainsInData")
	public void SearchContainsIn_France(String username, String password, String language, 
			...
			homePage.input_arthrex_logo_link();	
			Thread.sleep(5000);
		} // SearchContainsIn_France

/*
	@DataProvider
	public Object[][] getProductCodeData() {
		
	   Object data[][] =ExcelUtil.getTestData("SearchProductCodes_France");
	   return data;
	}
	
	@Test(dataProvider = "getProductCodes")
	public void SearchProductCodes_France (String username, String password, String language, 
			String searchText, String partNumber,
